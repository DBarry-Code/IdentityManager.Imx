...
We strongly recommend to read the [HTML Development Guide](https://docs.oneidentity.com/bundle/one-identity-manager_html5-development_10.0/page/sources/html5development/html5devintro.htm) before starting to work with the code in this repository.
...
Please refer to the [HTML Development Guide](https://docs.oneidentity.com/bundle/one-identity-manager_html5-development_10.0/page/sources/html5development/html5devintro.htm) for step-by-step instructions on getting started, building and deploying applications.
