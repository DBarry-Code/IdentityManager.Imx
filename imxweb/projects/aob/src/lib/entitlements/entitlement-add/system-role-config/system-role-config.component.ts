...
export class SystemRoleConfigComponent implements AfterViewInit, OnDestroy {
  ...
  public LdsAddOrCreate =
    '#LDS#Here you can merge the application entitlements into a new system role or add the application entitlements to an existing system role. The system role will then be assigned to the application as an application entitlement.';

  public LdsCreate =
    '#LDS#Here you can create an empty system role. The system role will then be assigned to the application as an application entitlement.';
}
