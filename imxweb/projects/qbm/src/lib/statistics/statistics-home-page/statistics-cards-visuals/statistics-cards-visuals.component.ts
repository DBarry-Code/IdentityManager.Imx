...
import { ChartDto, HeatmapDto } from '@imx-modules/imx-api-qbm';
...
import { PointStatTyped } from '../../charts/s-chart-tile/point-stat-visual/point-stat-typed';
...
export class StatisticsCardsVisualsComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this.showFavorites = this.dataService.isFavoritesEnabled;
  }
  ...
  public get areaName(): string {
    return this.stat.GetEntity().GetColumn('AreaName').GetValue();
  }
