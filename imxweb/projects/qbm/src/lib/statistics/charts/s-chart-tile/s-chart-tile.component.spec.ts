...
import { SChartTileComponent } from './s-chart-tile.component';

describe('SChartTileComponent', () => {
  let component: SChartTileComponent;
  ...
  beforeEach(() => {
    return MockBuilder(SChartTileComponent)
  ...
  beforeEach(() => {
    fixture = MockRender(SChartTileComponent, {
      summaryStat,
    });
