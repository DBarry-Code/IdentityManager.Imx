...
describe('DateParser', () => {
  ...
  [
    ...
    it(`should ${testcase.valid ? '' : 'not '}parse as date: ${testcase.text}`, () => {
  ...
  [
    ...
    it(`should ${testcase.valid ? '' : 'not '}parse as time: ${testcase.text}`, () => {
  ...
  [
    ...
    it(`should ${testcase.valid ? '' : 'not '}parse as date and time: ${testcase.text}`, () => {
      if (testcase.locale) {
