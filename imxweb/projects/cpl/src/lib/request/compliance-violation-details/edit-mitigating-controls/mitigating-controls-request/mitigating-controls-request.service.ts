...
export class MitigatingControlsRequestService {
  ...
  public createControl(uidPerson: string, uidNonCompliance: string): RequestMitigatingControls {
  ...
  public async deleteControl(mControl: MitigatingControlData): Promise<void> {
