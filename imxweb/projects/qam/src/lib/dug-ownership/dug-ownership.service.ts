...
export class DugOwnershipService {
  ...
  public async getPerceivedowners(uid: string): Promise<ExtendedTypedEntityCollection<PortalDgeResourcesPerceivedowners, unknown>> {
    return this.api.typedClient.PortalDgeResourcesPerceivedowners.Get(uid);
  }

  public get DugPerceivedOwnersSchema(): EntitySchema {
    return this.api.typedClient.PortalDgeResourcesPerceivedowners.GetSchema();
  }
