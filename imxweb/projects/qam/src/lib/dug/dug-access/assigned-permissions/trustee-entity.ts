...
export class TrusteeEntity extends TypedEntity {
  ...
  public static buildEntities(entityData: EntityData[], entitySchema: EntitySchema): ExtendedTypedEntityCollection<TrusteeEntity, unknown> {
    const builder = new TypedEntityBuilder(TrusteeEntity);
