...
export class AuditingGovernedDataService {

  constructor(private readonly api: QamApiService,) { }

  public get getNodesSchema() :EntitySchema{
     return this.api.typedClient.PortalDgeNodes.GetSchema();
  }
  
  public async getData(parameter?: CollectionLoadParameters,
      signal?: AbortSignal): Promise<ExtendedTypedEntityCollection<PortalDgeNodes, unknown>> {
      return this.api.typedClient.PortalDgeNodes.Get(parameter, { signal });
  }
}
