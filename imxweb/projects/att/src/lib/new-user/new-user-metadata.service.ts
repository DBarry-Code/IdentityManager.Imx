...
export class NewUserMetadataService extends MetadataService {
  constructor(
  ...
  protected async getTable(tableName: string, options?: any): Promise<MetaTableData | undefined> {
    return this.apiProvider.request(() => this.apiClient.client.register_metadata_table_get(tableName, options));
  }
}
