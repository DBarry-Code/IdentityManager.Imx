...
import { RegisterPerson } from '@imx-modules/imx-api-att';
import {
  CaptchaService,
  CdrFactoryService,
...
export class NewUserComponent implements OnInit, OnDestroy {
  ...
  public ldsCaptchaInfo = '#LDS#Enter the characters from the image.';
  public ldsAccountInfo =
    '#LDS#Your account "%CentralAccount%" has been successfully created and the email address "%DefaultEmailAddress%" has been assigned to the account. Once your account is approved, it will be activated.';
  ...
  public async save(): Promise<void> {
    ...
    this.messageSvc.subject.next({ text: '' });
