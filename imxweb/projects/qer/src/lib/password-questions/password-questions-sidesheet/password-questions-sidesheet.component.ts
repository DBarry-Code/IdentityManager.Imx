...
export class PasswordQuestionsSidesheetComponent implements AfterViewInit, OnDestroy {
   ...
   */
  public readonly formGroup: FormGroup<{ question: UntypedFormControl; answer: UntypedFormControl; confirmAnswer: UntypedFormControl }>;

  public passwordMatcher: any;
  public ldsHelperTextSavedQuestion =
    '#LDS#Your saved answer will not be displayed here and will be valid until a new answer is entered and saved. Note that your answer is case-sensitive and that you will have to enter your answer in the same way later.';
  public ldsHelperTextNewQuestion =
    '#LDS#Note that your answer is case-sensitive and that you will have to enter your answer in the same way later.';
  ...
  constructor(
    ...
    this.formGroup = new FormGroup({
      question: new UntypedFormControl(this.data.passwordQuestion.PasswordQuery.value, {
        updateOn: 'blur',
