...
export function getCartItemValidationStatus(check: ICartItemCheck): { status: string; icon: string; colorClass?: string } {
  switch (check.Status as CartItemValidationStatus) {
    ...
    case CartItemValidationStatus.error:
      return { status: 'Error', icon: 'cancel', colorClass: 'imx-error' };
    case CartItemValidationStatus.pending:
      return { status: 'Pending', icon: 'hourglass_empty' };
    case CartItemValidationStatus.success:
      return { status: 'Success', icon: 'done', colorClass: 'imx-new' };
    case CartItemValidationStatus.warning:
      return { status: 'Warning', icon: 'warning', colorClass: 'imx-warning' };
  }
}
