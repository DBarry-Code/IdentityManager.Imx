...
import { PortalItshopPatternItem } from '@imx-modules/imx-api-qer';

import { DisplayColumns, IEntityColumn } from '@imx-modules/imx-qbm-dbts';
...
export class ItshopPatternItemEditComponent implements OnInit {
  ...
  public detailsInfoText =
    '#LDS#Here you can see the details of the product. Additionally, you can pre-fill the values of the request parameters.';
