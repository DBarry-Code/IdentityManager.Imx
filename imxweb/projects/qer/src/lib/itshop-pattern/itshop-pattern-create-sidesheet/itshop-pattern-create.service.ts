...
import { PortalItshopPatternItem, PortalItshopPatternPrivate } from '@imx-modules/imx-api-qer';
...
export class ItshopPatternCreateService {
  ...
  public async assignItemsToPattern(items: PatternItemCandidate[], uidPattern: string = ''): Promise<number> {
  ...
  public async createNewPattern(showSnackbar: boolean): Promise<PortalItshopPatternPrivate | undefined> {
    ...
    if (newPattern) {
      ...
      const result = await this.sidesheet
        .open(ItshopPatternCreateSidesheetComponent, {
