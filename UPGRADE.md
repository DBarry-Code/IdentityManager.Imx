...
1. Check the [shared styles](./imxweb/shared/scss/styles.scss)
   ...
   Shared scss files contains all the common components, base variables and mixins which are usuful to maintain, update and cutomize the styles.
...
1. Commit all your changes in the branch.
1. Rebasing from v92 branch to v93. There are several different mothods to do it:

   - Use git rebase command e.g., `git rebase v93` (recommended). You need to resolve the conflicts by every commits.
